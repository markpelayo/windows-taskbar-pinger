...
// Fill direction. False is horizontal: across the top row, then down to the
// next — the way text is read, and the default.
inline constexpr bool    kFillVertical    = false;
...
inline constexpr wchar_t kVersion[]       = L"1.3.0";
